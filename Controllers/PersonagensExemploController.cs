...
namespace RpgApi.Controllers
{
    ...
    public class PersonagensExemploController : ControllerBase
    {
        ...
        Personagem p1 = new Personagem() { Id = 1, Nome = "Gerald", PontosVida = 100, Forca = 17 };
        personagens.Add(p1);*/
        ...
        public IActionResult GetOrdem() {
            List<Personagem> listFinal = personagens.OrderBy(p => p.Forca).ToList();
            return Ok(listFinal);
        }

        [HttpGet("GetContagem")]
        public IActionResult GetQualtidade() {
        ...
        {
            List<Personagem> listBusca = personagens.FindAll(p => p.Classe != ClasseEnum.Cavaleiro);
            return Ok(listBusca);
        }
        ...
        public IActionResult GetRemovendoMago() {
            ...
            return Ok("Personagens removido: " + pRemove.Nome);
        }
        ...
        public IActionResult GetByEnum(int enumId) {
            ClasseEnum enumDigito = (ClasseEnum)enumId;

            List<Personagem> listaBusca = personagens.FindAll(p => p.Classe == enumDigito);
            return Ok(listaBusca);
        }
        #endregion
